export class Vertical {
    constructor(onoff, x, y, l, n) {
        ...
        this.lineSetX = [this.l6, 0, -1 * this.l6, -1 * this.l6, 0, this.l6];
        this.lineSetY = [this.l6, this.l43, this.l6, -1 * this.l6, -1 * this.l43, -1 * this.l6];
        this.drawX = this.x;
        this.drawY = this.y - (this.l43 / 2 + this.l6);
    }
